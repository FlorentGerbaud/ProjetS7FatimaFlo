...
\subsection{GitHub Project Organization}
    ...
    \textbf{SMRT:} \textbf{S}imple \textbf{R}oad \textbf{T}raffic \textbf{M}odeling.
		...
		\subsubsection{Linear model}
			...
			\begin{algorithm}[H]
				\caption{SinusoidalModel}\label{alg:sinusoidal_model}
				\begin{algorithmic}
					\State \textbf{Input:} \\
					\begin{itemize}
				...
				\end{algorithmic}
			\end{algorithm}
			This algorithm allows for variations of acceleration that follows a sinusoidal model to simulate drunk drivers.
			\begin{algorithm}[H]
				\caption{StochasticDriverModel}\label{alg:stochastic_driver_model}
				\begin{algorithmic}
					\State \textbf{Input:}
					\begin{itemize}
