...
\begin{document}
	...
	\subsection{Simulation with Drivers Reacting Similarly}
		...
		In this type of simulation we make the model a little bit more realistic with variations of the acceleration of the car.
		In fact in this part we consider that one of the drivers is drunk. So the accelleration of the drivers change over the time.
		On the graph you could see that the accordion phenomenon that we just saw before is becoming no periodic and completely impermissible
