...
axes[0].plot(time, x1, label='$x_1(t)$')
axes[0].plot(time, x2, label='$x_2(t)$')
axes[0].plot(time, x3, label='$x_3(t)$')
...
axes[1].plot(time, x1_prime_values, label="$\dot{x_1}(t)$")
axes[1].plot(time, x2_prime_values, label="$\dot{x_2}(t)$")
axes[1].plot(time, x3_prime_values, label="$\dot{x_3}(t)$")
axes[1].set_xlabel('Time (s)')
axes[1].set_ylabel('Velocity ($\\frac{m}{s}$)')
axes[1].legend()
