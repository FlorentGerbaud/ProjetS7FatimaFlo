...
x1[0] = 30.0  # Initial value for x1 as specified
x2[0] = 10.0  # Initial value for x2 as specified , we verify also that the security disstance is respected
